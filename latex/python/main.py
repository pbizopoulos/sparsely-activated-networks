...
class SAN1d(nn.Module):
    ...
    def __init__(self: "SAN1d", kernel_sizes: list[int], sparse_activations: list[nn.Module]) -> None:
        super().__init__()
...
class SAN2d(nn.Module):
    ...
    def __init__(self: "SAN2d", kernel_sizes: list[int], sparse_activations: list[nn.Module]) -> None:
        super().__init__()
        self.sparse_activations = nn.ModuleList(sparse_activations)
