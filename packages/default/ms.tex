...
\begin{figure*}[!t]
  ...
  \subfloat[top-k absolutes]{\includegraphics[width=0.2\textwidth]{\FILEPATH/MNIST-top-k-absolutes-2d-2-activations-0.png}\label{subfig:topkabsolutes}}
  \subfloat[Extrema-Pool indices]{\includegraphics[width=0.2\textwidth]{\FILEPATH/MNIST-extrema-pool-indices-2d-2-activations-0.png}\label{subfig:extremapoolindices}}
...
\begin{figure*}[!t]
  \subfloat[1D SAN]{
    \begin{tikzpicture}[]
      \begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
        \node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-signal.png}};
        \node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
        \node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-reconstructed.png}};
        \node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
        \node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-reconstruction-0.png}};
        \node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
        \node[] at (4, -3){$\bm{r}^{(0)}$};
        \node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-activations-0.png}};
        \node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
        \node[] at (4, -6.3){$\bm{\alpha}^{(0)}$};
        \node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-similarity-0.png}};
        \node[] at (0.1, -6.3){$\bm{s}^{(0)}$};
        \node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{\FILEPATH/UCI-epilepsy-extrema-1d-2-kernel-0.png}};
      ...
      \begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
        \node[] at (0, 0)(input){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-signal.png}};
        \node[] at (0.1, 0.5){$\bm{x}$};
        \node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
        \node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-reconstructed.png}};
        \node[] at (4, 0.5){$\hat{\bm{x}}$};
        \node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
        \node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-reconstruction-0.png}};
        \node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
        \node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-activations-0.png}};
        \node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
        \node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-similarity-0.png}};
        \node[opacity=0, left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{\FILEPATH/UCI-epilepsy-extrema-1d-2-kernel-0.png}};
      ...
      \begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
        ...
        \node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-reconstructed.png}};
        \node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
        \node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-reconstruction-1.png}};
        \node[] at (4, -3){$\bm{r}^{(1)}$};
        \node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
        \node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-activations-1.png}};
        \node[] at (4, -6.3){$\bm{\alpha}^{(1)}$};
        \node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
        \node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{\FILEPATH/UCI-epilepsy-extrema-1d-2-similarity-1.png}};
        \node[] at (0.1, -6.3){$\bm{s}^{(1)}$};
        \node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{\FILEPATH/UCI-epilepsy-extrema-1d-2-kernel-1.png}};
  ...
  \subfloat[2D SAN]{
    \begin{tikzpicture}[]
      \begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
        \node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-signal.png}};
        \node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
        \node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-reconstructed.png}};
        \node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
        \node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-reconstruction-0.png}};
        \node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
        \node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-activations-0.png}};
        \node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
        \node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-similarity-0.png}};
        \node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{\FILEPATH/MNIST-extrema-2d-2-kernel-0.png}};
        \node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
      \end{scope}
      \begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
        \node[] at (0, 0)(input){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-signal.png}};
        \node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
        \node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-reconstructed.png}};
        \node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
        \node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-reconstruction-0.png}};
        \node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
        \node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-activations-0.png}};
        \node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
        \node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-similarity-0.png}};
        \node[opacity=0, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{\FILEPATH/MNIST-extrema-2d-2-kernel-0.png}};
        \node[draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
        \draw[->](input) -- node{} (conv1);
        \draw[->](conv1) -- node{} (similarity);
        \draw[->](similarity) -- node{} (phi);
      ...
      \begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
        ...
        \node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-reconstructed.png}};
        \node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
        \node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-reconstruction-1.png}};
        \node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
        \node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-activations-1.png}};
        \node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
        \node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{\FILEPATH/MNIST-extrema-2d-2-similarity-1.png}};
        \node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{\FILEPATH/MNIST-extrema-2d-2-kernel-1.png}};
        \node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
      \end{scope}
    \end{tikzpicture}
  }
...
\begin{figure*}[!t]
  \centering
  \subfloat[Density plot $CR^{-1}$ vs. $\tilde{\mathcal{L}}$]{\includegraphics[width=0.32\textwidth]{\FILEPATH/crrl-density-plot.png}\label{subfig:crrl_density_plot}}
  \subfloat[Confidence intervals $\bar\varphi$ vs. $epochs$]{\includegraphics[width=0.32\textwidth]{\FILEPATH/mean-flithos-validation-epochs.png}\label{subfig:flithos-epochs}}
  \subfloat[Confidence intervals $\bar\varphi$ vs. $m$]{\includegraphics[width=0.32\textwidth]{\FILEPATH/mean-flithos-variable-kernel-size-list.png}\label{subfig:flithos_m}}
