...
from utilities import path_paper
...
def save_images_2d(model, data, dataset_name, device):
    ...
    plt.savefig(f'{path_images_2d}/{dataset_name}_{model.sparse_activation.__name__}_{len(model.neuron_list)}_signal.pdf', bbox_inches='tight')
    plt.close()
    ...
    for index_neuron, (neuron, similarity, activations, reconstruction) in enumerate(zip(model.neuron_list, similarity_list[0, :, 0], activations_list[0, :, 0], reconstructions[0, :, 0])):
        ...
        plt.xticks([])
        plt.yticks([])
        plt.savefig(f'{path_images_2d}/{dataset_name}_{model.sparse_activation.__name__}_{len(model.neuron_list)}_kernel_{index_neuron}.pdf', bbox_inches='tight')
        plt.close()
        ...
        plt.savefig(f'{path_images_2d}/{dataset_name}_{model.sparse_activation.__name__}_{len(model.neuron_list)}_similarity_{index_neuron}.pdf', bbox_inches='tight')
        plt.close()
        ...
        plt.xticks([])
        plt.yticks([])
        plt.savefig(f'{path_images_2d}/{dataset_name}_{model.sparse_activation.__name__}_{len(model.neuron_list)}_activations_{index_neuron}.pdf', bbox_inches='tight')
        plt.close()
        ...
        plt.xticks([])
        plt.yticks([])
        plt.savefig(f'{path_images_2d}/{dataset_name}_{model.sparse_activation.__name__}_{len(model.neuron_list)}_reconstruction_{index_neuron}.pdf', bbox_inches='tight')
        plt.close()
    ...
    plt.savefig(f'{path_images_2d}/{dataset_name}_{model.sparse_activation.__name__}_{len(model.neuron_list)}_reconstructed.pdf', bbox_inches='tight')
    plt.close()
