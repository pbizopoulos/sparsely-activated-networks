...
\begin{figure*}[!t]
	\centering
	\subfloat{\includegraphics[width=0.2\textwidth]{tmp/UCI-epilepsy-identity-1d-2-activations-0.pdf}}
	\subfloat{\includegraphics[width=0.2\textwidth]{tmp/UCI-epilepsy-relu-1d-2-activations-0.pdf}}
	\subfloat{\includegraphics[width=0.2\textwidth]{tmp/UCI-epilepsy-top-k-absolutes-1d-2-activations-0.pdf}}
	\subfloat{\includegraphics[width=0.2\textwidth]{tmp/UCI-epilepsy-extrema-pool-indices-1d-2-activations-0.pdf}}
	\subfloat{\includegraphics[width=0.2\textwidth]{tmp/UCI-epilepsy-extrema-1d-2-activations-0.pdf}}
	\\
	\setcounter{subfigure}{0}
	\subfloat[Identity]{\includegraphics[width=0.2\textwidth]{tmp/MNIST-identity-2d-2-activations-1.pdf}\label{subfig:identity}}
	\subfloat[ReLU]{\includegraphics[width=0.2\textwidth]{tmp/MNIST-relu-2d-2-activations-0.pdf}\label{subfig:relu}}
	\subfloat[top-k absolutes]{\includegraphics[width=0.2\textwidth]{tmp/MNIST-top-k-absolutes-2d-2-activations-0.pdf}\label{subfig:topkabsolutes}}
	\subfloat[Extrema-Pool indices]{\includegraphics[width=0.2\textwidth]{tmp/MNIST-extrema-pool-indices-2d-2-activations-0.pdf}\label{subfig:extremapoolindices}}
	\subfloat[Extrema]{\includegraphics[width=0.2\textwidth]{tmp/MNIST-extrema-2d-2-activations-0.pdf}\label{subfig:extrema}}
...
\begin{figure*}[!t]
	\subfloat[1D SAN]{\begin{tikzpicture}[]
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
			\node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-signal.pdf}};
			\node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-reconstructed.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-reconstruction-0.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[] at (4, -3){$\bm{r}^{(0)}$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-activations-0.pdf}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[] at (4, -6.3){$\bm{\alpha}^{(0)}$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-similarity-0.pdf}};
			\node[] at (0.1, -6.3){$\bm{s}^{(0)}$};
			\node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/UCI-epilepsy-extrema-1d-2-kernel-0.pdf}};
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
			\node[] at (0, 0)(input){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-signal.pdf}};
			\node[] at (0.1, 0.5){$\bm{x}$};
			\node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-reconstructed.pdf}};
			\node[] at (4, 0.5){$\hat{\bm{x}}$};
			\node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-reconstruction-0.pdf}};
			\node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-activations-0.pdf}};
			\node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
			\node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-similarity-0.pdf}};
			\node[opacity=0, left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/UCI-epilepsy-extrema-1d-2-kernel-0.pdf}};
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
			...
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-reconstructed.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-reconstruction-1.pdf}};
			\node[] at (4, -3){$\bm{r}^{(1)}$};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-activations-1.pdf}};
			\node[] at (4, -6.3){$\bm{\alpha}^{(1)}$};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-1d-2-similarity-1.pdf}};
			\node[] at (0.1, -6.3){$\bm{s}^{(1)}$};
			\node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/UCI-epilepsy-extrema-1d-2-kernel-1.pdf}};
	...
	\subfloat[2D SAN]{\begin{tikzpicture}[]
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
			\node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-signal.pdf}};
			\node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-reconstructed.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-reconstruction-0.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-activations-0.pdf}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-similarity-0.pdf}};
			\node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/MNIST-extrema-2d-2-kernel-0.pdf}};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
			\node[] at (0, 0)(input){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-signal.pdf}};
			\node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-reconstructed.pdf}};
			\node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-reconstruction-0.pdf}};
			\node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-activations-0.pdf}};
			\node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
			\node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-similarity-0.pdf}};
			\node[opacity=0, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/MNIST-extrema-2d-2-kernel-0.pdf}};
			\node[draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
			\draw[->](input) -- node{} (conv1);
			\draw[->](conv1) -- node{} (similarity);
			\draw[->](similarity) -- node{} (phi);
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
			...
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-reconstructed.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-reconstruction-1.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-activations-1.pdf}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2d-2-similarity-1.pdf}};
			\node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/MNIST-extrema-2d-2-kernel-1.pdf}};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
	\end{tikzpicture}
	}
...
\begin{figure*}[!t]
	\includegraphics[width=0.245\textwidth]{tmp/apnea-ecg.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/bidmc.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/bpssrat.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/cebsdb.pdf}
	\\
	\includegraphics[width=0.245\textwidth]{tmp/ctu-uhb-ctgdb.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/drivedb.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/emgdb.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/mitdb.pdf}
	\\
	\includegraphics[width=0.245\textwidth]{tmp/noneeg.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/prcp.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/shhpsgdb.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/slpdb.pdf}
	\\
	\includegraphics[width=0.245\textwidth]{tmp/sufhsdb.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/voiced.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/wrist.pdf}
	\includegraphics[width=0.245\textwidth]{tmp/legend.pdf}
...
\begin{figure*}[!t]
	\centering
	\subfloat[Density plot $CR^{-1}$ vs. $\tilde{\mathcal{L}}$]{\includegraphics[width=0.32\textwidth]{tmp/crrl-density-plot.pdf}\label{subfig:crrl_density_plot}}
	\subfloat[Confidence intervals $\bar\varphi$ vs. $epochs$]{\includegraphics[width=0.32\textwidth]{tmp/mean-flithos-validation-epochs.pdf}\label{subfig:flithos-epochs}}
	\subfloat[Confidence intervals $\bar\varphi$ vs. $m$]{\includegraphics[width=0.32\textwidth]{tmp/mean-flithos-variable-kernel-size-list.pdf}\label{subfig:flithos_m}}
...
\begin{figure*}[!t]
	\centering
	\includegraphics[width=0.06\textwidth]{tmp/apnea-ecg-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/bidmc-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/bpssrat-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/cebsdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/ctu-uhb-ctgdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/drivedb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/emgdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/mitdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/noneeg-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/prcp-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/shhpsgdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/slpdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/sufhsdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/voiced-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/wrist-relu-1d-1-kernel-0.pdf}
	\\
	\includegraphics[width=0.06\textwidth]{tmp/apnea-ecg-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/bidmc-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/bpssrat-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/cebsdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/ctu-uhb-ctgdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/drivedb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/emgdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/mitdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/noneeg-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/prcp-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/shhpsgdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/slpdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/sufhsdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/voiced-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/wrist-top-k-absolutes-1d-1-kernel-0.pdf}
	\\
	\includegraphics[width=0.06\textwidth]{tmp/apnea-ecg-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/bidmc-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/bpssrat-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/cebsdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/ctu-uhb-ctgdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/drivedb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/emgdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/mitdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/noneeg-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/prcp-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/shhpsgdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/slpdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/sufhsdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/voiced-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/wrist-extrema-pool-indices-1d-1-kernel-0.pdf}
	\\
	\includegraphics[width=0.06\textwidth]{tmp/apnea-ecg-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/bidmc-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/bpssrat-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/cebsdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/ctu-uhb-ctgdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/drivedb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/emgdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/mitdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/noneeg-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/prcp-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/shhpsgdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/slpdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/sufhsdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/voiced-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{tmp/wrist-extrema-1d-1-kernel-0.pdf}
...
\begin{table*}[!t]
	...
	\begin{adjustbox}{width=\textwidth}
		\input{tmp/table-flithos-variable-kernel-size.tex}
	\end{adjustbox}
\end{table*}
...
\begin{table*}[!t]
	...
	\begin{adjustbox}{width=\textwidth}
		\input{tmp/table-uci-epilepsy-supervised.tex}
	\end{adjustbox}
\end{table*}
...
\begin{table*}[!t]
	...
	\begin{adjustbox}{width=\textwidth}
		\input{tmp/table-mnist-supervised.tex}
	\end{adjustbox}
\end{table*}
...
\begin{table*}[!t]
	...
	\begin{adjustbox}{width=\textwidth}
		\input{tmp/table-fashionmnist-supervised.tex}
	\end{adjustbox}
\end{table*}
