...
Although ReLU creates exact zeros (unlike its predecessors $sigmoid$ and $tanh$), its activation map consists of sparsely separated but still dense areas (Fig.~\ref{fig:activationfunctions}\subref{subfig:relu}) instead of sparse spikes.
...
\begin{figure*}[!t]
	\centering
	\subfloat{\includegraphics[width=0.2\textwidth]{"results/UCI-epilepsy_identity_1d_2_activations_0"}}
	\subfloat{\includegraphics[width=0.2\textwidth]{"results/UCI-epilepsy_relu_1d_2_activations_0"}}
	\subfloat{\includegraphics[width=0.2\textwidth]{"results/UCI-epilepsy_topk_absolutes_1d_2_activations_0"}}
	\subfloat{\includegraphics[width=0.2\textwidth]{"results/UCI-epilepsy_extrema_pool_indices_1d_2_activations_0"}}
	\subfloat{\includegraphics[width=0.2\textwidth]{"results/UCI-epilepsy_extrema_1d_2_activations_0"}}
	\\
	\setcounter{subfigure}{0}
	\subfloat[Identity]{\includegraphics[width=0.2\textwidth]{"results/MNIST_identity_2d_2_activations_1"}\label{subfig:identity}}
	\subfloat[ReLU]{\includegraphics[width=0.2\textwidth]{"results/MNIST_relu_2d_2_activations_0"}\label{subfig:relu}}
	\subfloat[top-k absolutes]{\includegraphics[width=0.2\textwidth]{"results/MNIST_topk_absolutes_2d_2_activations_0"}\label{subfig:topkabsolutes}}
	\subfloat[Extrema-Pool indices]{\includegraphics[width=0.2\textwidth]{"results/MNIST_extrema_pool_indices_2d_2_activations_0"}\label{subfig:extremapoolindices}}
	\subfloat[Extrema]{\includegraphics[width=0.2\textwidth]{"results/MNIST_extrema_2d_2_activations_0"}\label{subfig:extrema}}
...
\begin{figure*}[!t]
	\subfloat[1D SAN]{\begin{tikzpicture}[]
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
			\node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_signal"}};
			\node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_reconstructed"}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_reconstruction_0"}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[] at (4.5, -3.1){$\bm{r}^{(0)}$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_activations_0"}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[] at (4.5, -6.8){$\bm{\alpha}^{(0)}$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_similarity_0"}};
			\node[] at (0.1, -6.8){$\bm{s}^{(0)}$};
			\node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{"results/UCI-epilepsy_extrema_1d_2_kernel_0"}};
			\node[] at (2.3, -5){\tiny $\bm{w}^{(0)}$};
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
			\node[] at (0, 0)(input){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_signal"}};
			\node[] at (0.1, 0.7){$\bm{x}$};
			\node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_reconstructed"}};
			\node[] at (4.5, 0.7){$\hat{\bm{x}}$};
			\node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_reconstruction_0"}};
			\node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_activations_0"}};
			\node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
			\node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_similarity_0"}};
			\node[opacity=0, left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{"results/UCI-epilepsy_extrema_1d_2_kernel_0"}};
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
			...
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_reconstructed"}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_reconstruction_1"}};
			\node[] at (4.5, -3.1){$\bm{r}^{(1)}$};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_activations_1"}};
			\node[] at (4.5, -6.8){$\bm{\alpha}^{(1)}$};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{"results/UCI-epilepsy_extrema_1d_2_similarity_1"}};
			\node[] at (0.1, -6.8){$\bm{s}^{(1)}$};
			\node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{"results/UCI-epilepsy_extrema_1d_2_kernel_1"}};
			\node[] at (2.3, -5){\tiny $\bm{w}^{(1)}$};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
	\end{tikzpicture}
	}
	...
	\subfloat[2D SAN]{\begin{tikzpicture}[]
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
			\node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_signal"}};
			\node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_reconstructed"}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_reconstruction_0"}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_activations_0"}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_similarity_0"}};
			\node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{"results/MNIST_extrema_2d_2_kernel_0"}};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
			\node[] at (0, 0)(input){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_signal"}};
			\node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_reconstructed"}};
			\node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_reconstruction_0"}};
			\node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_activations_0"}};
			\node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
			\node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_similarity_0"}};
			\node[opacity=0, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{"results/MNIST_extrema_2d_2_kernel_0"}};
			\node[draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
			\draw[->](input) -- node{} (conv1);
			\draw[->](conv1) -- node{} (similarity);
			\draw[->](similarity) -- node{} (phi);
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
			...
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_reconstructed"}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_reconstruction_1"}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_activations_1"}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{"results/MNIST_extrema_2d_2_similarity_1"}};
			\node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{"results/MNIST_extrema_2d_2_kernel_1"}};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
	\end{tikzpicture}
	}
...
\begin{figure*}[!t]
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_apnea-ecg"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_bidmc"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_bpssrat"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_cebsdb"}
	\\
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_ctu-uhb-ctgdb"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_drivedb"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_emgdb"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_mitdb"}
	\\
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_noneeg"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_prcp"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_shhpsgdb"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_slpdb"}
	\\
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_sufhsdb"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_voiced"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_wrist"}
	\includegraphics[width=0.245\textwidth]{"results/mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list_legend"}
...
\begin{figure*}[!t]
	\centering
	\subfloat[Density plot $CR^{-1}$ vs. $\tilde{\mathcal{L}}$]{\includegraphics[width=0.32\textwidth]{"results/crrl_density_plot"}\label{subfig:crrl_density_plot}}
	\subfloat[Confidence intervals $\bar\varphi$ vs. $epochs$]{\includegraphics[width=0.32\textwidth]{"results/mean_flithos_validation_epochs"}\label{subfig:flithos_epochs}}
	\subfloat[Confidence intervals $\bar\varphi$ vs. $m$]{\includegraphics[width=0.32\textwidth]{"results/mean_flithos_variable_kernel_size_list"}\label{subfig:flithos_m}}
	\caption{Aggregated results of the evaluation of the Physionet databases using the $\bar\varphi$ metric.
	The density plot was created using kernel density estimation with Gaussian kernels and the confidence intervals denote one standard deviation.}
	\label{fig:flithos}
\end{figure*}

\begin{figure*}[!t]
	\centering
	\includegraphics[width=0.06\textwidth]{"results/apnea-ecg_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/bidmc_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/bpssrat_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/cebsdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/ctu-uhb-ctgdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/drivedb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/emgdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/mitdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/noneeg_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/prcp_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/shhpsgdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/slpdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/sufhsdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/voiced_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/wrist_relu_1d_1_kernel_0"}
	\\
	\includegraphics[width=0.06\textwidth]{"results/apnea-ecg_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/bidmc_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/bpssrat_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/cebsdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/ctu-uhb-ctgdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/drivedb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/emgdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/mitdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/noneeg_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/prcp_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/shhpsgdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/slpdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/sufhsdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/voiced_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/wrist_topk_absolutes_1d_1_kernel_0"}
	\\
	\includegraphics[width=0.06\textwidth]{"results/apnea-ecg_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/bidmc_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/bpssrat_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/cebsdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/ctu-uhb-ctgdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/drivedb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/emgdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/mitdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/noneeg_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/prcp_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/shhpsgdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/slpdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/sufhsdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/voiced_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/wrist_extrema_pool_indices_1d_1_kernel_0"}
	\\
	\includegraphics[width=0.06\textwidth]{"results/apnea-ecg_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/bidmc_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/bpssrat_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/cebsdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/ctu-uhb-ctgdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/drivedb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/emgdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/mitdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/noneeg_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/prcp_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/shhpsgdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/slpdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/sufhsdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/voiced_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"results/wrist_extrema_1d_1_kernel_0"}
...
\begin{table*}[!t]
	...
	\input{results/mean_inverse_compression_ratio_mean_reconstruction_loss_variable_kernel_size.tex}
\end{table*}
...
\begin{table*}[!t]
	...
	\input{results/uci_epilepsy_supervised.tex}
\end{table*}
...
\begin{table*}[!t]
	...
	\input{results/mnist_supervised.tex}
\end{table*}
...
\begin{table*}[!t]
	...
	\input{results/fashionmnist_supervised.tex}
\end{table*}
