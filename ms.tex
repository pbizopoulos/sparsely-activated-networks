...
\begin{figure*}[!t]
	\centering
	\subfloat{\includegraphics[width=0.2\textwidth]{results/UCI-epilepsy-identity-2-activations-0}}
	\subfloat{\includegraphics[width=0.2\textwidth]{results/UCI-epilepsy-relu-2-activations-0}}
	\subfloat{\includegraphics[width=0.2\textwidth]{results/UCI-epilepsy-top-k-absolutes-2-activations-0}}
	\subfloat{\includegraphics[width=0.2\textwidth]{results/UCI-epilepsy-extrema-pool-idx-2-activations-0}}
	\subfloat{\includegraphics[width=0.2\textwidth]{results/UCI-epilepsy-extrema-2-activations-0}}
	\\
	\setcounter{subfigure}{0}
	\subfloat[Identity]{\includegraphics[width=0.2\textwidth]{results/MNIST-identity-2-activations-1}\label{subfig:identity}}
	\subfloat[ReLU]{\includegraphics[width=0.2\textwidth]{results/MNIST-relu-2-activations-0}\label{subfig:relu}}
	\subfloat[top-k absolutes]{\includegraphics[width=0.2\textwidth]{results/MNIST-top-k-absolutes-2-activations-0}\label{subfig:topkabsolutes}}
	\subfloat[Extrema-Pool indices]{\includegraphics[width=0.2\textwidth]{results/MNIST-extrema-pool-idx-2-activations-0}\label{subfig:extremapoolindices}}
	\subfloat[Extrema]{\includegraphics[width=0.2\textwidth]{results/MNIST-extrema-2-activations-0}\label{subfig:extrema}}
...
\begin{figure*}[!t]
	\subfloat[1D SAN]{\begin{tikzpicture}[]
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
			\node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-signal}};
			\node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-reconstructed}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-reconstruction-0}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[] at (4, -3){$\bm{r}^{(0)}$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-activations-0}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[] at (4, -6.3){$\bm{\alpha}^{(0)}$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-similarity-0}};
			\node[] at (0.1, -6.3){$\bm{s}^{(0)}$};
			\node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{results/UCI-epilepsy-extrema-2-kernel-0}};
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
			\node[] at (0, 0)(input){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-signal}};
			\node[] at (0.1, 0.5){$\bm{x}$};
			\node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-reconstructed}};
			\node[] at (4, 0.5){$\hat{\bm{x}}$};
			\node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-reconstruction-0}};
			\node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-activations-0}};
			\node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
			\node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-similarity-0}};
			\node[opacity=0, left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{results/UCI-epilepsy-extrema-2-kernel-0}};
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
			...
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-reconstructed}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-reconstruction-1}};
			\node[] at (4, -3){$\bm{r}^{(1)}$};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-activations-1}};
			\node[] at (4, -6.3){$\bm{\alpha}^{(1)}$};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{results/UCI-epilepsy-extrema-2-similarity-1}};
			\node[] at (0.1, -6.3){$\bm{s}^{(1)}$};
			\node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{results/UCI-epilepsy-extrema-2-kernel-1}};
	...
	\subfloat[2D SAN]{\begin{tikzpicture}[]
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
			\node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-signal}};
			\node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-reconstructed}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-reconstruction-0}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-activations-0}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-similarity-0}};
			\node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{results/MNIST-extrema-2-kernel-0}};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
			\node[] at (0, 0)(input){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-signal}};
			\node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-reconstructed}};
			\node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-reconstruction-0}};
			\node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-activations-0}};
			\node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
			\node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-similarity-0}};
			\node[opacity=0, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{results/MNIST-extrema-2-kernel-0}};
			\node[draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
			\draw[->](input) -- node{} (conv1);
			\draw[->](conv1) -- node{} (similarity);
			\draw[->](similarity) -- node{} (phi);
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
			...
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-reconstructed}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-reconstruction-1}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-activations-1}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{results/MNIST-extrema-2-similarity-1}};
			\node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{results/MNIST-extrema-2-kernel-1}};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
	\end{tikzpicture}
	}
...
\begin{figure*}[!t]
	\centering
	\includegraphics[width=0.06\textwidth]{results/apnea-ecg-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/bidmc-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/bpssrat-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/cebsdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/ctu-uhb-ctgdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/drivedb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/emgdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/mitdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/noneeg-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/prcp-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/shhpsgdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/slpdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/sufhsdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/voiced-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/wrist-relu-1-kernel-0}
	\\
	\includegraphics[width=0.06\textwidth]{results/apnea-ecg-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/bidmc-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/bpssrat-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/cebsdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/ctu-uhb-ctgdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/drivedb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/emgdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/mitdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/noneeg-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/prcp-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/shhpsgdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/slpdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/sufhsdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/voiced-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/wrist-top-k-absolutes-1-kernel-0}
	\\
	\includegraphics[width=0.06\textwidth]{results/apnea-ecg-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/bidmc-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/bpssrat-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/cebsdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/ctu-uhb-ctgdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/drivedb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/emgdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/mitdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/noneeg-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/prcp-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/shhpsgdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/slpdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/sufhsdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/voiced-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/wrist-extrema-pool-idx-1-kernel-0}
	\\
	\includegraphics[width=0.06\textwidth]{results/apnea-ecg-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/bidmc-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/bpssrat-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/cebsdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/ctu-uhb-ctgdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/drivedb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/emgdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/mitdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/noneeg-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/prcp-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/shhpsgdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/slpdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/sufhsdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/voiced-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{results/wrist-extrema-1-kernel-0}
