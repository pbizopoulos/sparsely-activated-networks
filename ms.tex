...
\begin{figure*}[!t]
	\centering
	\subfloat{\includegraphics[width=0.2\textwidth]{tmp/UCI-epilepsy-identity-2-activations-0}}
	\subfloat{\includegraphics[width=0.2\textwidth]{tmp/UCI-epilepsy-relu-2-activations-0}}
	\subfloat{\includegraphics[width=0.2\textwidth]{tmp/UCI-epilepsy-top-k-absolutes-2-activations-0}}
	\subfloat{\includegraphics[width=0.2\textwidth]{tmp/UCI-epilepsy-extrema-pool-idx-2-activations-0}}
	\subfloat{\includegraphics[width=0.2\textwidth]{tmp/UCI-epilepsy-extrema-2-activations-0}}
	\\
	\setcounter{subfigure}{0}
	\subfloat[Identity]{\includegraphics[width=0.2\textwidth]{tmp/MNIST-identity-2-activations-1}\label{subfig:identity}}
	\subfloat[ReLU]{\includegraphics[width=0.2\textwidth]{tmp/MNIST-relu-2-activations-0}\label{subfig:relu}}
	\subfloat[top-k absolutes]{\includegraphics[width=0.2\textwidth]{tmp/MNIST-top-k-absolutes-2-activations-0}\label{subfig:topkabsolutes}}
	\subfloat[Extrema-Pool indices]{\includegraphics[width=0.2\textwidth]{tmp/MNIST-extrema-pool-idx-2-activations-0}\label{subfig:extremapoolindices}}
	\subfloat[Extrema]{\includegraphics[width=0.2\textwidth]{tmp/MNIST-extrema-2-activations-0}\label{subfig:extrema}}
...
\begin{figure*}[!t]
	\subfloat[1D SAN]{\begin{tikzpicture}[]
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
			\node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-signal}};
			\node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-reconstructed}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-reconstruction-0}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[] at (4, -3){$\bm{r}^{(0)}$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-activations-0}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[] at (4, -6.3){$\bm{\alpha}^{(0)}$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-similarity-0}};
			\node[] at (0.1, -6.3){$\bm{s}^{(0)}$};
			\node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/UCI-epilepsy-extrema-2-kernel-0}};
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
			\node[] at (0, 0)(input){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-signal}};
			\node[] at (0.1, 0.5){$\bm{x}$};
			\node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-reconstructed}};
			\node[] at (4, 0.5){$\hat{\bm{x}}$};
			\node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-reconstruction-0}};
			\node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-activations-0}};
			\node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
			\node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-similarity-0}};
			\node[opacity=0, left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/UCI-epilepsy-extrema-2-kernel-0}};
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
			...
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-reconstructed}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-reconstruction-1}};
			\node[] at (4, -3){$\bm{r}^{(1)}$};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-activations-1}};
			\node[] at (4, -6.3){$\bm{\alpha}^{(1)}$};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/UCI-epilepsy-extrema-2-similarity-1}};
			\node[] at (0.1, -6.3){$\bm{s}^{(1)}$};
			\node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/UCI-epilepsy-extrema-2-kernel-1}};
	...
	\subfloat[2D SAN]{\begin{tikzpicture}[]
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
			\node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-signal}};
			\node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-reconstructed}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-reconstruction-0}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-activations-0}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-similarity-0}};
			\node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/MNIST-extrema-2-kernel-0}};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
			\node[] at (0, 0)(input){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-signal}};
			\node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-reconstructed}};
			\node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-reconstruction-0}};
			\node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-activations-0}};
			\node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
			\node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-similarity-0}};
			\node[opacity=0, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/MNIST-extrema-2-kernel-0}};
			\node[draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
			\draw[->](input) -- node{} (conv1);
			\draw[->](conv1) -- node{} (similarity);
			\draw[->](similarity) -- node{} (phi);
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
			...
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-reconstructed}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-reconstruction-1}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-activations-1}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{tmp/MNIST-extrema-2-similarity-1}};
			\node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{tmp/MNIST-extrema-2-kernel-1}};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
	\end{tikzpicture}
	}
...
\begin{figure*}[!t]
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-apnea-ecg}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-bidmc}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-bpssrat}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-cebsdb}
	\\
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-ctu-uhb-ctgdb}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-drivedb}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-emgdb}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-mitdb}
	\\
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-noneeg}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-prcp}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-shhpsgdb}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-slpdb}
	\\
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-sufhsdb}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-voiced}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-wrist}
	\includegraphics[width=0.245\textwidth]{tmp/mean-inverse-compression-ratio-vs-mean-reconstruction-loss-variable-kernel-size-list-legend}
...
\begin{figure*}[!t]
	\centering
	\subfloat[Density plot $CR^{-1}$ vs. $\tilde{\mathcal{L}}$]{\includegraphics[width=0.32\textwidth]{tmp/crrl-density-plot}\label{subfig:crrl_density_plot}}
	\subfloat[Confidence intervals $\bar\varphi$ vs. $epochs$]{\includegraphics[width=0.32\textwidth]{tmp/mean-flithos-validation-epochs}\label{subfig:flithos-epochs}}
	\subfloat[Confidence intervals $\bar\varphi$ vs. $m$]{\includegraphics[width=0.32\textwidth]{tmp/mean-flithos-variable-kernel-size-list}\label{subfig:flithos_m}}
...
\begin{figure*}[!t]
	\centering
	\includegraphics[width=0.06\textwidth]{tmp/apnea-ecg-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/bidmc-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/bpssrat-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/cebsdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/ctu-uhb-ctgdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/drivedb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/emgdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/mitdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/noneeg-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/prcp-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/shhpsgdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/slpdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/sufhsdb-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/voiced-relu-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/wrist-relu-1-kernel-0}
	\\
	\includegraphics[width=0.06\textwidth]{tmp/apnea-ecg-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/bidmc-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/bpssrat-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/cebsdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/ctu-uhb-ctgdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/drivedb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/emgdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/mitdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/noneeg-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/prcp-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/shhpsgdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/slpdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/sufhsdb-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/voiced-top-k-absolutes-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/wrist-top-k-absolutes-1-kernel-0}
	\\
	\includegraphics[width=0.06\textwidth]{tmp/apnea-ecg-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/bidmc-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/bpssrat-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/cebsdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/ctu-uhb-ctgdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/drivedb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/emgdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/mitdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/noneeg-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/prcp-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/shhpsgdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/slpdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/sufhsdb-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/voiced-extrema-pool-idx-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/wrist-extrema-pool-idx-1-kernel-0}
	\\
	\includegraphics[width=0.06\textwidth]{tmp/apnea-ecg-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/bidmc-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/bpssrat-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/cebsdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/ctu-uhb-ctgdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/drivedb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/emgdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/mitdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/noneeg-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/prcp-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/shhpsgdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/slpdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/sufhsdb-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/voiced-extrema-1-kernel-0}
	\includegraphics[width=0.06\textwidth]{tmp/wrist-extrema-1-kernel-0}
...
\begin{table*}[!t]
	...
	\input{tmp/mean-inverse-compression-ratio-mean-reconstruction-loss-variable-kernel-size.tex}
\end{table*}
...
\begin{table*}[!t]
	...
	\input{tmp/uci-epilepsy-supervised.tex}
\end{table*}
...
\begin{table*}[!t]
	...
	\input{tmp/mnist-supervised.tex}
\end{table*}
...
\begin{table*}[!t]
	...
	\input{tmp/fashionmnist-supervised.tex}
\end{table*}
