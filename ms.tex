...
\begin{figure*}[!t]
	\centering
	\subfloat{\includegraphics[width=0.2\textwidth]{artifacts/UCI-epilepsy-identity-1d-2-activations-0.pdf}}
	\subfloat{\includegraphics[width=0.2\textwidth]{artifacts/UCI-epilepsy-relu-1d-2-activations-0.pdf}}
	\subfloat{\includegraphics[width=0.2\textwidth]{artifacts/UCI-epilepsy-top-k-absolutes-1d-2-activations-0.pdf}}
	\subfloat{\includegraphics[width=0.2\textwidth]{artifacts/UCI-epilepsy-extrema-pool-indices-1d-2-activations-0.pdf}}
	\subfloat{\includegraphics[width=0.2\textwidth]{artifacts/UCI-epilepsy-extrema-1d-2-activations-0.pdf}}
	\\
	\setcounter{subfigure}{0}
	\subfloat[Identity]{\includegraphics[width=0.2\textwidth]{artifacts/MNIST-identity-2d-2-activations-1.pdf}\label{subfig:identity}}
	\subfloat[ReLU]{\includegraphics[width=0.2\textwidth]{artifacts/MNIST-relu-2d-2-activations-0.pdf}\label{subfig:relu}}
	\subfloat[top-k absolutes]{\includegraphics[width=0.2\textwidth]{artifacts/MNIST-top-k-absolutes-2d-2-activations-0.pdf}\label{subfig:topkabsolutes}}
	\subfloat[Extrema-Pool indices]{\includegraphics[width=0.2\textwidth]{artifacts/MNIST-extrema-pool-indices-2d-2-activations-0.pdf}\label{subfig:extremapoolindices}}
	\subfloat[Extrema]{\includegraphics[width=0.2\textwidth]{artifacts/MNIST-extrema-2d-2-activations-0.pdf}\label{subfig:extrema}}
...
\begin{figure*}[!t]
	\subfloat[1D SAN]{\begin{tikzpicture}[]
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
			\node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-signal.pdf}};
			\node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-reconstructed.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-reconstruction-0.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[] at (4, -3){$\bm{r}^{(0)}$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-activations-0.pdf}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[] at (4, -6.3){$\bm{\alpha}^{(0)}$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-similarity-0.pdf}};
			\node[] at (0.1, -6.3){$\bm{s}^{(0)}$};
			\node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{artifacts/UCI-epilepsy-extrema-1d-2-kernel-0.pdf}};
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
			\node[] at (0, 0)(input){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-signal.pdf}};
			\node[] at (0.1, 0.5){$\bm{x}$};
			\node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-reconstructed.pdf}};
			\node[] at (4, 0.5){$\hat{\bm{x}}$};
			\node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-reconstruction-0.pdf}};
			\node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-activations-0.pdf}};
			\node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
			\node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-similarity-0.pdf}};
			\node[opacity=0, left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{artifacts/UCI-epilepsy-extrema-1d-2-kernel-0.pdf}};
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
			...
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-reconstructed.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-reconstruction-1.pdf}};
			\node[] at (4, -3){$\bm{r}^{(1)}$};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-activations-1.pdf}};
			\node[] at (4, -6.3){$\bm{\alpha}^{(1)}$};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{artifacts/UCI-epilepsy-extrema-1d-2-similarity-1.pdf}};
			\node[] at (0.1, -6.3){$\bm{s}^{(1)}$};
			\node[left=1.5cm of conv2] (kernel){\includegraphics[scale=0.1]{artifacts/UCI-epilepsy-extrema-1d-2-kernel-1.pdf}};
	...
	\subfloat[2D SAN]{\begin{tikzpicture}[]
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=-0.5,xscale=-1, transform shape]
			\node[opacity=0] at (0, 0)(input){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-signal.pdf}};
			\node[opacity=0, draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-reconstructed.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-reconstruction-0.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-activations-0.pdf}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-similarity-0.pdf}};
			\node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{artifacts/MNIST-extrema-2d-2-kernel-0.pdf}};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0,xscale=-1, transform shape]
			\node[] at (0, 0)(input){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-signal.pdf}};
			\node[draw, right=0.5cm of input, circle] (loss){$\mathcal{L}$};
			\node[right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-reconstructed.pdf}};
			\node[draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-reconstruction-0.pdf}};
			\node[draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-activations-0.pdf}};
			\node[draw, left=0.55cm of extrema, circle, inner sep=2pt] (phi){$\phi$};
			\node[opacity=0, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-similarity-0.pdf}};
			\node[opacity=0, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{artifacts/MNIST-extrema-2d-2-kernel-0.pdf}};
			\node[draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
			\draw[->](input) -- node{} (conv1);
			\draw[->](conv1) -- node{} (similarity);
			\draw[->](similarity) -- node{} (phi);
		...
		\begin{scope}[tdplot_main_coords, canvas is yz plane at x=0.5,xscale=-1, transform shape]
			...
			\node[opacity=0, right=0.5cm of loss] (reconstructed){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-reconstructed.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstructed, circle] (plus){$+$};
			\node[opacity=0.8, below=0.5cm of plus] (reconstruction){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-reconstruction-1.pdf}};
			\node[opacity=0, draw, below=0.5cm of reconstruction, circle] (conv2){$\ast$};
			\node[opacity=0.8, below=0.5cm of conv2] (extrema){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-activations-1.pdf}};
			\node[opacity=0, draw, left=0.55cm of extrema, circle] (phi){$\phi$};
			\node[opacity=0.8, left=0.55cm of phi] (similarity){\includegraphics[scale=\figscale]{artifacts/MNIST-extrema-2d-2-similarity-1.pdf}};
			\node[opacity=0.8, left=1.2cm of conv2] (kernel){\includegraphics[scale=0.1]{artifacts/MNIST-extrema-2d-2-kernel-1.pdf}};
			\node[opacity=0, draw, above=0.5cm of similarity, circle] (conv1){$\ast$};
		\end{scope}
	\end{tikzpicture}
	}
...
\begin{figure*}[!t]
	\includegraphics[width=0.245\textwidth]{artifacts/apnea-ecg.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/bidmc.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/bpssrat.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/cebsdb.pdf}
	\\
	\includegraphics[width=0.245\textwidth]{artifacts/ctu-uhb-ctgdb.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/drivedb.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/emgdb.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/mitdb.pdf}
	\\
	\includegraphics[width=0.245\textwidth]{artifacts/noneeg.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/prcp.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/shhpsgdb.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/slpdb.pdf}
	\\
	\includegraphics[width=0.245\textwidth]{artifacts/sufhsdb.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/voiced.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/wrist.pdf}
	\includegraphics[width=0.245\textwidth]{artifacts/legend.pdf}
...
\begin{figure*}[!t]
	\centering
	\subfloat[Density plot $CR^{-1}$ vs. $\tilde{\mathcal{L}}$]{\includegraphics[width=0.32\textwidth]{artifacts/crrl-density-plot.pdf}\label{subfig:crrl_density_plot}}
	\subfloat[Confidence intervals $\bar\varphi$ vs. $epochs$]{\includegraphics[width=0.32\textwidth]{artifacts/mean-flithos-validation-epochs.pdf}\label{subfig:flithos-epochs}}
	\subfloat[Confidence intervals $\bar\varphi$ vs. $m$]{\includegraphics[width=0.32\textwidth]{artifacts/mean-flithos-variable-kernel-size-list.pdf}\label{subfig:flithos_m}}
...
\begin{figure*}[!t]
	\centering
	\includegraphics[width=0.06\textwidth]{artifacts/apnea-ecg-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/bidmc-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/bpssrat-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/cebsdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/ctu-uhb-ctgdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/drivedb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/emgdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/mitdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/noneeg-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/prcp-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/shhpsgdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/slpdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/sufhsdb-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/voiced-relu-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/wrist-relu-1d-1-kernel-0.pdf}
	\\
	\includegraphics[width=0.06\textwidth]{artifacts/apnea-ecg-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/bidmc-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/bpssrat-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/cebsdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/ctu-uhb-ctgdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/drivedb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/emgdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/mitdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/noneeg-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/prcp-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/shhpsgdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/slpdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/sufhsdb-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/voiced-top-k-absolutes-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/wrist-top-k-absolutes-1d-1-kernel-0.pdf}
	\\
	\includegraphics[width=0.06\textwidth]{artifacts/apnea-ecg-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/bidmc-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/bpssrat-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/cebsdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/ctu-uhb-ctgdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/drivedb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/emgdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/mitdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/noneeg-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/prcp-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/shhpsgdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/slpdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/sufhsdb-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/voiced-extrema-pool-indices-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/wrist-extrema-pool-indices-1d-1-kernel-0.pdf}
	\\
	\includegraphics[width=0.06\textwidth]{artifacts/apnea-ecg-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/bidmc-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/bpssrat-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/cebsdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/ctu-uhb-ctgdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/drivedb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/emgdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/mitdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/noneeg-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/prcp-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/shhpsgdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/slpdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/sufhsdb-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/voiced-extrema-1d-1-kernel-0.pdf}
	\includegraphics[width=0.06\textwidth]{artifacts/wrist-extrema-1d-1-kernel-0.pdf}
...
\begin{table*}[!t]
	...
	\begin{adjustbox}{width=\textwidth}
		\input{artifacts/table-flithos-variable-kernel-size.tex}
	\end{adjustbox}
\end{table*}
...
\begin{table*}[!t]
	...
	\begin{adjustbox}{width=\textwidth}
		\input{artifacts/table-uci-epilepsy-supervised.tex}
	\end{adjustbox}
\end{table*}
...
\begin{table*}[!t]
	...
	\begin{adjustbox}{width=\textwidth}
		\input{artifacts/table-mnist-supervised.tex}
	\end{adjustbox}
\end{table*}
...
\begin{table*}[!t]
	...
	\begin{adjustbox}{width=\textwidth}
		\input{artifacts/table-fashionmnist-supervised.tex}
	\end{adjustbox}
\end{table*}
