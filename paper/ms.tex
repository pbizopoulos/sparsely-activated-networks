...
\begin{figure*}[!t]
	...
	\subfloat[top-k absolutes]{\includegraphics[width=0.2\textwidth]{"images_2d/MNIST_topk_absolutes_2d_2_activations_0"}\label{subfig:topkabsolutes}}
...
\begin{figure*}[!t]
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/apnea-ecg"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/bidmc"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/bpssrat"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/cebsdb"}
	\\
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/ctu-uhb-ctgdb"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/drivedb"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/emgdb"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/mitdb"}
	\\
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/noneeg"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/prcp"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/shhpsgdb"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/slpdb"}
	\\
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/sufhsdb"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/voiced"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/wrist"}
	\includegraphics[width=0.245\textwidth]{"images_mean_inverse_compression_ratio_vs_mean_reconstruction_loss_variable_kernel_size_list/legend"}
...
\begin{figure*}[!t]
	\centering
	\subfloat[Density plot $CR^{-1}$ vs. $\tilde{\mathcal{L}}$]{\includegraphics[width=0.32\textwidth]{"images_1d/crrl_density_plot"}\label{subfig:crrl_density_plot}}
	\subfloat[Confidence intervals $\bar\varphi$ vs. $epochs$]{\includegraphics[width=0.32\textwidth]{"images_1d/mean_flithos_validation_epochs"}\label{subfig:flithos_epochs}}
	\subfloat[Confidence intervals $\bar\varphi$ vs. $m$]{\includegraphics[width=0.32\textwidth]{"images_1d/mean_flithos_variable_kernel_size_list"}\label{subfig:flithos_m}}
...
\begin{figure*}[!t]
	\centering
	\includegraphics[width=0.06\textwidth]{"images_1d/apnea-ecg_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/bidmc_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/bpssrat_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/cebsdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/ctu-uhb-ctgdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/drivedb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/emgdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/mitdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/noneeg_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/prcp_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/shhpsgdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/slpdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/sufhsdb_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/voiced_relu_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/wrist_relu_1d_1_kernel_0"}
	\\
	\includegraphics[width=0.06\textwidth]{"images_1d/apnea-ecg_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/bidmc_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/bpssrat_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/cebsdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/ctu-uhb-ctgdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/drivedb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/emgdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/mitdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/noneeg_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/prcp_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/shhpsgdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/slpdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/sufhsdb_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/voiced_topk_absolutes_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/wrist_topk_absolutes_1d_1_kernel_0"}
	\\
	\includegraphics[width=0.06\textwidth]{"images_1d/apnea-ecg_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/bidmc_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/bpssrat_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/cebsdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/ctu-uhb-ctgdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/drivedb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/emgdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/mitdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/noneeg_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/prcp_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/shhpsgdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/slpdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/sufhsdb_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/voiced_extrema_pool_indices_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/wrist_extrema_pool_indices_1d_1_kernel_0"}
	\\
	\includegraphics[width=0.06\textwidth]{"images_1d/apnea-ecg_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/bidmc_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/bpssrat_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/cebsdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/ctu-uhb-ctgdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/drivedb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/emgdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/mitdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/noneeg_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/prcp_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/shhpsgdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/slpdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/sufhsdb_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/voiced_extrema_1d_1_kernel_0"}
	\includegraphics[width=0.06\textwidth]{"images_1d/wrist_extrema_1d_1_kernel_0"}
...
\begin{table*}[!t]
	...
	\input{tables/mean_inverse_compression_ratio_mean_reconstruction_loss_variable_kernel_size.tex}
\end{table*}
...
\begin{table*}[!t]
	...
	\input{tables/uci_epilepsy_supervised.tex}
\end{table*}
...
\begin{table*}[!t]
	...
	\setlength\tabcolsep{4.2pt}
	\input{tables/mnist_supervised.tex}
\end{table*}
...
\begin{table*}[!t]
	...
	\setlength\tabcolsep{4.2pt}
	\input{tables/fashionmnist_supervised.tex}
\end{table*}
